      ...
      >
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', marginBottom: '5px', color: '#00ff99' }}>Name</label>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          {/* Email */}
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', marginBottom: '5px', color: '#00ff99' }}>Email</label>
            <input
              type="email"
              name="email"
          ...
          <div style={{ marginBottom: '25px' }}>
            <label style={{ display: 'block', marginBottom: '5px', color: '#00ff99' }}>Message / Project Details</label>
            <textarea
              name="message"
